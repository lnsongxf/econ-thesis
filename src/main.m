...
% CEX bondholders
[results9, data3] = implied_rates('cex-bondholders', 0.2, phi_d, nu_d);
[results10, ~]    = implied_rates('cex-bondholders', 0.5, phi_d, nu_d);
[results11, ~]    = implied_rates('cex-bondholders', 1,   phi_d, nu_d);
[results12, ~]    = implied_rates('cex-bondholders', 2,   phi_d, nu_d);
...
% CEX nonbondholders
[results13, data4] = implied_rates('cex-nonbondholders', 0.2, phi_d, nu_d);
[results14, ~]     = implied_rates('cex-nonbondholders', 0.5, phi_d, nu_d);
[results15, ~]     = implied_rates('cex-nonbondholders', 1,   phi_d, nu_d);
[results16, ~]     = implied_rates('cex-nonbondholders', 2,   phi_d, nu_d);
