...
%     
% %     chi_1t = ((1-alpha) - 1)*Et_c_tp1 - phi*(1-alpha)*c_t ...
% %         - Et_pi_tp1 ...
% %         + 1/2*((1-alpha) - 1)^2*Vt_c_tp1 ...
% %         + 1/2*Vt_pi_tp1 ...
% %         - ((1-alpha) - 1)*Ct_c_pi_tp1;
% %     
% %     chi_2t = (1-alpha)*Et_c_tp2 - (phi*(1-alpha) + 1)*Et_c_tp1 ...
% %         - Et_pi_tp1 ...
% %         + 1/2*((1-alpha))^2*Vt_c_tp2 ...
% %         + 1/2*(phi*(1-alpha) + 1)^2*Vt_c_tp1 ...
% %         + 1/2*Vt_pi_tp1 ...
% %         - (1-alpha)*Ct_pi_tp1_c_tp2 ...
% %         + (phi*(1-alpha) + 1)*Ct_c_pi_tp1 ...
% %         - (1-alpha)*(phi*(1-alpha) + 1)*Ct_c_tp1_tp2;
% %     
% %     chi_3t = ((1-alpha) - 1)*c_t - phi*(1-alpha)*c_tm1;
% %     
% %     chi_4t = (1-alpha)*Et_c_tp1 - (phi*(1-alpha) + 1)*c_t ...
% %         + 1/2*((1-alpha))^2*Vt_c_tp1;
%     
...
%     nom(i).corr = corrcoef(I_t_scaled(collard), FFR_t_scaled(collard));
% end
...
for i = 2:2
    ...
    chi_real_1t = -alpha*Et_c_tp1 - phi*(1-alpha)*c_t;% ...
       % + 1/2*((1-alpha) - 1)^2*Vt_c_tp1;
    
    chi_real_2t = (1-alpha)*Et_c_tp2 - (phi*(1-alpha) + 1)*Et_c_tp1;% ...
        %+ 1/2*((1-alpha))^2*Vt_c_tp2 ...
        %+ 1/2*(phi*(1-alpha) + 1)^2*Vt_c_tp1 ...
        %- (1-alpha)*(phi*(1-alpha) + 1)*Ct_c_tp1_tp2;
    
    chi_real_3t = -alpha*c_t - phi*(1-alpha)*c_tm1;
    
    chi_real_4t = (1-alpha)*Et_c_tp1 - (phi*(1-alpha) + 1)*c_t;% ...
        %+ 1/2*((1-alpha))^2*Vt_c_tp1;
    ...
    real(i).corr = corrcoef(R_t_scaled(collard), FFR_real_t_scaled(collard));
end